import { pocketbaseProductService as productService } from "./products.pocketbase";
import { pocketbaseCategoryService as categoryService } from "./categories.pocketbase";
import { pocketbaseUserService as userService } from "./users.pocketbase";
import { pocketbaseOrderService as orderService } from "./orders.pocketbase";
...
class PocketBaseStatisticsService {
    /**
    ...
    async getBusinessStats(): Promise<BusinessStats> {
        try {
            ...
            // Consulta servicios individualmente para ser resilientes a colecciones faltantes
            const fetchProducts = async () => {
                try { return await productService.getAllAdmin(); } catch (e) { console.error("Error products:", e); return []; }
            };
            const fetchCategories = async () => {
                try { return await categoryService.getAll(); } catch (e) { console.error("Error categories:", e); return []; }
            };
            const fetchUsers = async () => {
                try { return await userService.getAll(); } catch (e) { console.error("Error users:", e); return []; }
            };
            const fetchOrders = async () => {
                try { return await orderService.getAll(); } catch (e) { console.error("Error orders:", e); return []; }
            };
...
export const pocketbaseStatisticsService = new PocketBaseStatisticsService();
